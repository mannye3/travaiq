...
<main class="flex-1 min-w-0 overflow-x-hidden">
    ...
    <div class="max-w-screen-xl mx-auto px-4">
        ...
        <!-- Gentle Save Prompt (replaces harsh yellow warnings) -->
        <div class="bg-gradient-to-r from-custom-purple-50 to-custom-purple-100 border border-custom-purple-200 rounded-lg p-4 mb-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <svg class="w-5 h-5 text-custom-purple-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span class="text-custom-purple-700 font-medium">Love this itinerary? Save it for later and get exclusive booking discounts!</span>
                </div>
                <a href="{{ route('loginRegister') }}" class="bg-custom-purple-600 text-white px-6 py-2 rounded-lg hover:bg-custom-purple-700 transition-colors font-medium">
                    Save Trip Free
                </a>
            </div>
        </div>
        ...
        <section class="mb-8 lg:mb-16 pb-6 pt-6" id="hero">
            ...
            <div class="flex flex-wrap gap-4 mb-6">
                ...
                {{-- <button onclick="downloadPDF()" class="flex items-center px-6 py-3 bg-custom-purple-600 text-white rounded-lg hover:bg-custom-purple-700 transition-colors font-medium">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        Best prices guaranteed • No booking fees
                    ...
                    <div class="mt-12">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="https://www.getyourguide.com/s/?partner_id=8WZ0ASL&utm_medium=online_publisher&cmp=deal&q={{ $tripDetails->location }}&searchSource=3&deeplink_id=240bfd3a-d380-54af-bc0c-8923b1395bb9&page_id=126a3896-62a3-56f1-bfd0-bb37a509bc07"
                               target="_blank" class="px-4 py-2 bg-custom-purple-600 text-white rounded-md hover:bg-custom-purple-700 transition-colors">
                                Book All Activities
                            </a>
                        </div>
                                            ...
                                            <div class="flex items-center justify-between p-4 bg-white border-b cursor-pointer"
                                                ...
                                                <div class="flex items-center gap-4">
                                                    <div class="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
                                                        <span class="text-purple-600 font-semibold">{{ $itinerary->day }}</span>
                                                    </div>
                                                    <div>
                                                            ...
                                                            <div class="flex-1">
                                                                <div class="bg-gray-50 rounded-lg p-4">
                                                                    <div class="flex flex-col md:flex-row gap-4">
                                                                        <div class="flex-1">
                                                                            <h3 class="font-semibold text-gray-900 mb-2">{{ $activity->name }}</h3>
                                                                            ...
                                                                            @if($activity->website)
                                                                            <div class="flex items-center gap-2 text-sm text-gray-500 mt-2">
                                                                                <a href="{{ $activity->website }}" target="_blank" class="text-custom-purple-600 hover:underline">🌐 Visit Website</a>
                                                                            </div>
                                                                            @endif
                                                                        ...
                                                                        <div class="w-full md:w-32 h-24 rounded-lg overflow-hidden">
                                                                            ...
                                                                            @else
                                                                                <img src="https://img.freepik.com/premium-photo/high-angle-view-smart-phone-table_1048944-29197645.jpg?w=900" alt="{{ $activity->name }}" class="w-full h-full object-cover">
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                                </div>
                        ...
                        @else
                            <!-- Same structure for logged-in users with enhanced CTAs -->
                            <div>
                                @foreach ($itineraries as $itinerary)
                                    <div class="bg-white rounded-lg shadow-sm mb-4 overflow-hidden">
                                        <div class="flex items-center justify-between p-4 bg-white border-b cursor-pointer"
                                                            ...
                                                            <div class="bg-gray-50 rounded-lg p-4">
                                                                <div class="flex flex-col md:flex-row gap-4">
                                                                    <div class="flex-1">
                                                                        ...
                                                                        <div class="flex items-center gap-2 text-sm text-gray-500 mt-2">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9m0 9c-5 0-9-4-9-9s4-9 9-9m9 9c-1.11 0-2.08.402-2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9v-9m0-9v9m0 9c-5 0-9-4-9-9s4-9 9-9" />
                                                                            </svg>
                                                                            <a href="{{ $activity->website }}" target="_blank" class="text-custom-purple-600 hover:underline">Visit Website</a>
                                                                        </div>
                                                                        @endif
                                                                        ...
                                                                        <!-- Enhanced Activity Booking CTAs -->
                                                                        <div class="mt-3 flex flex-wrap gap-2">
                                                                            <a href="https://www.getyourguide.com/s/?partner_id=8WZ0ASL&q={{ urlencode($activity->name) }}" 
                                                                               target="_blank" 
                                                                               class="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700 transition-colors">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="space-y-3 ml-8">
                                <span class="text-gray-600">Safety Rating:
                                    <strong>{{ $securityAdvice->overall_safety_rating }}</strong>
                                </span>
                                <br>
                                <span class="text-gray-600">Emergency Numbers:
                                    <strong>{{ $securityAdvice->emergency_numbers }}</strong>
                                </span>
                                <br><br>
                                <span class="text-gray-600">Common scams:
                                    {{ $securityAdvice->common_scams }}
                                </span>
                                <br><br>
                                <span class="text-gray-600">Health Precautions:
                                    {{ $securityAdvice->health_precautions }}
                                </span>
                            </div>
                        </div>
...
<div class="fixed bottom-4 right-4 bg-purple-600 text-white p-4 rounded-lg shadow-lg max-w-sm z-50 hidden" id="upgrade-prompt">
    <button onclick="closeUpgrade()" class="absolute top-2 right-2 text-white text-xl">&times;</button>
    <div class="flex items-center mb-2">
        <span class="text-2xl mr-2">⭐</span>
        <h4 class="font-bold">Save Your Trip</h4>
    </div>
    <p class="text-sm mb-3">Register or login to save this trip and get exclusive booking discounts</p>
    <button onclick="registerOrLogin()" class="bg-white text-purple-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors">
        Register / Login
    </button>
</div>
...
{{-- <div class="fixed bottom-4 right-4 bg-purple-600 text-white p-4 rounded-lg shadow-lg max-w-sm z-50 hidden" id="upgrade-prompt">
    ...
    <p class="text-sm mb-3">Get offline access, trip collaboration, and 15% booking discounts</p>
    <button onclick="upgradeToPro()" class="bg-white text-purple-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-100 transition-colors">
        Upgrade $9.99/month
    </button>
</div> --}}
...
// Action functions
function saveTrip() {
    window.location.href = "{{ route('loginRegister') }}";
}
