...
@section('content')
                                                    ...
                                                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                                                        ...
                                                        <div class="p-4">
                                                            ...
                                                            <div class="flex items-center gap-1 mb-3">
                                                                ...
                                                                <span class="text-gray-600 text-sm">{{ $hotel->rating }}</span>
                                                            </div>
    ...
    <script>
        ...
        function updateScrollButtons() {
            ...
            scrollRight.disabled = currentPosition <= -(slider.scrollWidth - container.clientWidth);
        }
